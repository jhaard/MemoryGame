...
fun GameOverView(navController: NavController, score: Int) {
    ...
    GameButton(navController = navController, route = "start_screen", buttonText = "Back to Start")
    GameButton(navController = navController, route = "game_screen", buttonText = "Retry")
